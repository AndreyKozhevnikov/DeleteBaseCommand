//------------------------------------------------------------------------------
// <copyright file="DeleteBaseCommandPackage.cs" company="Company">
...
namespace DeleteBaseCommand {
    ...
    public sealed class DeleteBaseCommandPackage : Package {
        /// <summary>
        /// DeleteBaseCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "41a16108-695d-465d-99c9-fc8a81f3915a";
        ...
        protected override void Initialize() {
            DeleteBaseCommand.Initialize(this);
            base.Initialize();
        }
